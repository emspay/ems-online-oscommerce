...
class emspay {
  ...
  function emspay() {
    ...
    $this->code = 'emspay';
    $this->title_selection = MODULE_PAYMENT_EMSPAY_TEXT_TITLE;
    $this->title = MODULE_PAYMENT_EMSPAY_TEXT_TITLE;
    $this->description = MODULE_PAYMENT_EMSPAY_TEXT_DESCRIPTION;
    $this->sort_order = 0;
    $this->enabled = ( ( MODULE_PAYMENT_EMSPAY_STATUS == 'True' ) ? true : false );
  ...
  function check() {
    if ( !isset( $this->_check ) ) {
      $check_query = tep_db_query( "select configuration_value from " . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_PAYMENT_EMSPAY_STATUS'" );
  ...
  function install() {
    ...
    $add_array = array(
      ...
      "configuration_key" => 'MODULE_PAYMENT_EMSPAY_STATUS',
      "configuration_value" => 'False',
      "configuration_description" => 'Do you want to accept payments using EMS Online?',
    ...
    $add_array = array(
      ...
      "configuration_key" => 'MODULE_PAYMENT_EMSPAY_APIKEY',
      "configuration_value" => '',
    ...
    $add_array = array(
      ...
      "configuration_key" => 'MODULE_PAYMENT_EMSPAY_NEW_STATUS_ID',
    ...
    $add_array = array(
      ...
      "configuration_key" => 'MODULE_PAYMENT_EMSPAY_PENDING_STATUS_ID',
      "configuration_value" => intval( DEFAULT_ORDERS_STATUS_ID ),
    ...
    $add_array = array(
      ...
      "configuration_key" => 'MODULE_PAYMENT_EMSPAY_COMPLETE_STATUS_ID',
    ...
    $add_array = array(
      ...
      "configuration_key" => 'MODULE_PAYMENT_EMSPAY_CANCELLED_STATUS_ID',
      "configuration_value" => intval( DEFAULT_ORDERS_STATUS_ID ),
    ...
    $add_array = array(
      ...
      "configuration_key" => 'MODULE_PAYMENT_EMSPAY_ERROR_STATUS_ID',
      "configuration_value" => intval( DEFAULT_ORDERS_STATUS_ID ),
    ...
    $add_array = array(
      ...
      "configuration_key" => 'MODULE_PAYMENT_EMSPAY_DEBUG_MODE',
      "configuration_value" => 'False',
      "configuration_description" => 'In DEBUG mode request are logged from the ems_pay',
      "configuration_group_id " => '6',
      "sort_order" => $sort_order,
      "set_function" => "tep_cfg_select_option(array('True', 'False'), ",
      "date_added " => 'now()',
    ...
    $add_array = array(
      ...
      "configuration_key" => 'MODULE_PAYMENT_EMSPAY_LOG_TO',
  ...
  function keys() {
    return array(
      ...
      'MODULE_PAYMENT_EMSPAY_CANCELLED_STATUS_ID',
      'MODULE_PAYMENT_EMSPAY_ERROR_STATUS_ID',
      'MODULE_PAYMENT_EMSPAY_DEBUG_MODE',
      'MODULE_PAYMENT_EMSPAY_LOG_TO',
    );
  }
