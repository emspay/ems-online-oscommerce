...
class emspay_klarnapaynow {
  ...
  function after_process() {
    ...
    if ( !is_array( $emspay_order ) or array_key_exists( 'error', $emspay_order) or $emspay_order['status'] == 'error' ) {
      ...
      $this->tep_remove_order( $insert_id, $restock = true );
        $reason = "Error placing Klarna Pay Now order ";
  ...
  function install() {
    ...
    $add_array = array(
      ...
      "configuration_description" => 'Do you want to accept Klarna Pay Now payments using EMS Online?',
